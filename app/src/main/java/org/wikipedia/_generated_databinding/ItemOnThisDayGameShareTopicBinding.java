...
public final class ItemOnThisDayGameShareTopicBinding implements ViewBinding {
  @NonNull
  ...
  private ItemOnThisDayGameShareTopicBinding(@NonNull ConstraintLayout rootView,
      @NonNull GoneIfEmptyTextView listItemDescription,
  ...
  @NonNull
  public static ItemOnThisDayGameShareTopicBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemOnThisDayGameShareTopicBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_on_this_day_game_share_topic, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemOnThisDayGameShareTopicBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOnThisDayGameShareTopicBinding((ConstraintLayout) rootView,
          listItemDescription, listItemThumbnail, listItemTitle);
    }
